...
│   └── script_pad.txt                  <-- Código de acciones del flujo
    └── ReameFlujoExcel                 <-- Documentación del flujo de escritorio que realiza operaciones y escribe en una hoja de cálculo
└── 02-Flujo-Nube-CloudFlow/            <-- Herramienta 2: Cloud Flow
    ...
    └── ReadmeFlujoNube                 <-- Documentación del flujo en la nube que envia correos
